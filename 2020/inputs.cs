namespace _2020
{
	public class inputs
    {
        ...
        public static string D1P1 = @"1408
1335
1648
1458
1627
...
1529";
        ...
        public static string D2P1 = @"1-2 x: xpxc
1-5 b: bwlbbbbcq
3-5 v: qvjjdhvl
...
";
        ...
        public static string D5P1 = @"FBBFBBBRLL
FBBFFBFLLL
BFFFFFFLRL
FBFBFFFLRR
BBBFBFBRLL
...
tlpyhvnoxsagwmqrdzcue";
        ...
        public static string D7P1 = @"light plum bags contain 1 faded blue bag.
...
pale tan bags contain 5 posh gray bags, 3 wavy violet bags.";
        ...
        public static string D8P1 = @"acc +15
jmp +461
acc +6
nop +445
jmp +324
...
152";
        ...
        public static string D11P1 = @"LLLLLLLLL.LLLLLLL.LLLLLLLLLL.LLLLL.LLLLLL.LLLLLLLL.L.LLLLLL..L.LLLLL.LLLLLLLLLL.LLLLLLLLLLL
...
F27";
        ...
        public static string D13P1 = @"1008713
13,x,x,41,x,x,x,x,x,x,x,x,x,467,x,x,x,x,x,x,x,x,x,x,x,19,x,x,x,x,17,x,x,x,x,x,x,x,x,x,x,x,29,x,353,x,x,x,x,x,37,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,23";
        ...
        public static string D14P1 = @"mask = 0X11XX1X010X01101000X01X011101100000
mem[4634] = 907
mem[54949] = 444591415
mem[5445] = 1446
mem[2822] = 702866
...
mem[48579] = 15039";
        ...
        public static string D16P1 = @"departure location: 31-221 or 241-952
...
#..##.##";
        ...
        public static string D18P1 = @"4 * (7 + 5 + 7) + 9 + 2 * ((5 * 6) * 9 + 6 + 3) + 3
5 + (4 * (3 + 2 + 5 + 9 * 3))
...
7 + 7";
        ...
        public static string D19P1 = @"80: 20 10 | 39 12
76: 20 10 | 39 107
9: 20 2 | 39 74
22: 39 82 | 20 40
65: 25 20 | 127 39
...
bbbabbbbabbabbababababbabbbaaaaaabaabbabbaabbabb";
        ...
        public static string D20P1 = @"Tile 3593:
#..#.##...
.#..#.#...
.#####..#.
.......#.#
...
32";
        ...
        public static string D24P1 = @"swnenewnenenwneneeseseenwwnesenenenenene
